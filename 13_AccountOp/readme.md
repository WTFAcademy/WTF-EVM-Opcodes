...
账户结构非常简单，你可以把账户当成地址到账户状态的映射。账户的地址是20字节（160位）的数据，可以用40位的16进制表示，比如`0x9bbfed6889322e016e0a02ee459d306fc19545d8`。而账户的状态具有以下属性：
...
为了支持账户相关的指令，我们利用`dict`给极简EVM做一个简单账户数据库：
